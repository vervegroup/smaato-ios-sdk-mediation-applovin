...
- (void)initializeWithParameters:(id<MAAdapterInitializationParameters>)parameters completionHandler:(void (^)(MAAdapterInitializationStatus, NSString *_Nullable))completionHandler {
    ...
    dispatch_once(&onceToken, ^{
        ...
        NSString *pubID = [parameters.customParameters al_stringForKey: PARAM_PUB_ID defaultValue: DUMMY_ID];
        ...
        if([SmaatoSDK isSDKInitialized]){
            ...
            ALSmaatoInitializationStatus = MAAdapterInitializationStatusInitializedFailure;
            [self log: @"Smaato SDK initialized failure"];
            completionHandler(ALSmaatoInitializationStatus,nil);
        }
    });
